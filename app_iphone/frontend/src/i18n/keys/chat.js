...
export default {
  pt: {
    ...
    'chat.menu.otaChecking': 'verificando…',
    'chat.menu.otaOutdated': 'desatualizado',
    'chat.menu.otaDownloading': 'baixando…',
    'chat.menu.otaError': 'erro ao atualizar',
    'chat.menu.otaUpdateTitle': 'Atualizar agora',
    'chat.menu.otaUpdateHint': 'Tem uma versão nova esperando. Toque pra baixar e reabrir já atualizado.',
    'chat.menu.otaDownloadingHint': 'Baixando a atualização…',
    'chat.menu.otaUpdatingOverlay': 'Atualizando…',
  },
  en: {
    ...
    'chat.menu.otaEmbedded': 'build',
    'chat.menu.otaChecking': 'checking…',
    'chat.menu.otaOutdated': 'outdated',
    'chat.menu.otaDownloading': 'downloading…',
    'chat.menu.otaError': 'update failed',
    'chat.menu.otaUpdateTitle': 'Update now',
    'chat.menu.otaUpdateHint': 'A new version is waiting. Tap to download and reopen updated.',
    'chat.menu.otaDownloadingHint': 'Downloading the update…',
    'chat.menu.otaUpdatingOverlay': 'Updating…',
  },
};
